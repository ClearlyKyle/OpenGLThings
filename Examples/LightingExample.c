...
void LightingExample_Init()
{
    ...
    vec3 light_position = {0.5f, 0.5f, 1.5f};
    ...
    Shader_Uniform_Mat4(lights.shader[0], "model", light_model);
    Shader_Uniform_Vec4(lights.shader[0], "lightColor", light_colour);

    Shader_Bind(lights.shader[1]);
    Shader_Uniform_Mat4(lights.shader[1], "model", pyramid_model);
    Shader_Uniform_Vec4(lights.shader[1], "lightColor", light_colour);
    Shader_Uniform_Vec4(lights.shader[1], "lightPos", light_position);
