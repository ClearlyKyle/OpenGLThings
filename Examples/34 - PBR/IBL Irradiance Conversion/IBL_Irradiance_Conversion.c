...
static struct IBL_Irradiance_Conversion
{
    Camera_t cam;
...
void IBL_Irradiance_Conversion_Init()
{
    ...
    // Shaders
    ibl.pbrShader                      = Shader_Create("../../Examples/34 - PBR/IBL Irradiance Conversion/pbr.vs", "../../Examples/34 - PBR/IBL Irradiance Conversion/pbr.fs", 0, NULL);
    ibl.equirectangularToCubemapShader = Shader_Create("../../Examples/34 - PBR/IBL Irradiance Conversion/cubemap.vs", "../../Examples/34 - PBR/IBL Irradiance Conversion/equirectangular_to_cubemap.fs", 0, NULL);
    ibl.backgroundShader               = Shader_Create("../../Examples/34 - PBR/IBL Irradiance Conversion/background.vs", "../../Examples/34 - PBR/IBL Irradiance Conversion/background.fs", 0, NULL);
    ...
    ibl.hdrTexture = hdrTexture;
}

void IBL_Irradiance_Conversion_Update()
{
    ...
    // Shader_Bind(ibl.equirectangularToCubemapShader);
    // Shader_Uniform_Mat4(ibl.equirectangularToCubemapShader, "view", view);
    // glActiveTexture(GL_TEXTURE0);
...
void IBL_Irradiance_Conversion_OnExit()
{
